...
/*
 N5110 LCD pinout -> Arduino:       ||ESP8266
 #1 RST      - Pin  9 or any digital
 #2 CS/CE    - Pin 10 or any digital
 #3 DC       - Pin  8 or any digital
 #4 MOSI/DIN - Pin 11 / SPI            D7
 #5 SCK/CLK  - Pin 13 / SPI            D5
 #6 VCC 3.3V
 #7 LIGHT (200ohm to GND) (or to 5v, whichever works!)
 #8 GND

 * ESP8266 SPI: SCK is D5, MOSI is D7 (and there is no MISO since displays dont talk back), 
 * RST,CS,DC   user defined
*/
...
//N5110_SPI lcd(D1, D2, D3); // RST,CS,DC
N5110_SPI lcd(D1, D2, D3, D7, D5); //(rst, cs, dc, din, clk)
